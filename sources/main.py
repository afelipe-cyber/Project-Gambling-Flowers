...
puit = ursina.Entity(model="sources/models_compressed/Well.obj", texture="data/casa/Well_texture.png", scale=(0.5), position=(0, 1, 0), double_sided=True, collider="mesh", shader=ursina.shaders.lit_with_shadows_shader)
